...
export default function Sidebar({ onClose }) {
  ...
  return (
    <aside className="sidebar">
      <div style={{ padding: '0.1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid var(--border-color)', marginBottom: '0.5rem', background: '#fff' }}>
        <img src="/logo.png" alt="INVENTX" style={{ height: '160px', width: 'auto', maxWidth: '220px', objectFit: 'contain' }} onError={(e) => e.target.style.display='none'} />
      </div>
