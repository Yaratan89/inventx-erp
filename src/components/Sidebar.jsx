...
export default function Sidebar({ onClose }) {
  ...
  return (
    <aside className="sidebar">
      <div style={{ padding: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid var(--border-color)', marginBottom: '0.75rem', background: '#fff' }}>
        <img src="/logo.png" alt="INVENTX" style={{ height: '160px', width: 'auto', maxWidth: '210px', objectFit: 'contain' }} onError={(e) => e.target.style.display='none'} />
      </div>
